...
fn default_claim_generator() -> String { "UMRS Reference System/1.0".into() }
fn default_organization()    -> String { "UMRS".into() }
fn default_algorithm()       -> String { "es256".into() }
fn default_unsigned_action() -> String { "c2pa.acquired".into() }
fn default_signed_action()   -> String { "c2pa.published".into() }
...
fn default_signed_reason() -> String {
    "Received at UMRS trusted ingest dropbox with existing provenance. No modifications made.".into()
}
